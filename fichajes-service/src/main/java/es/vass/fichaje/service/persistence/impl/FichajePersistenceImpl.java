...
public class FichajePersistenceImpl extends BasePersistenceImpl<Fichaje>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_USERID = new FinderPath(FichajeModelImpl.ENTITY_CACHE_ENABLED,
			FichajeModelImpl.FINDER_CACHE_ENABLED, FichajeImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_USERID =
		new FinderPath(FichajeModelImpl.ENTITY_CACHE_ENABLED,
			...
			FichajeModelImpl.USERID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_USERID = new FinderPath(FichajeModelImpl.ENTITY_CACHE_ENABLED,
			FichajeModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<Fichaje> findByUserId(long userId, int start, int end) {
	...
	public Fichaje findByUserId_First(long userId,
		OrderByComparator<Fichaje> orderByComparator)
		throws NoSuchFichajeException {
		Fichaje fichaje = fetchByUserId_First(userId, orderByComparator);
	...
	public Fichaje fetchByUserId_First(long userId,
		OrderByComparator<Fichaje> orderByComparator) {
		List<Fichaje> list = findByUserId(userId, 0, 1, orderByComparator);
	...
	public Fichaje findByUserId_Last(long userId,
		OrderByComparator<Fichaje> orderByComparator)
		throws NoSuchFichajeException {
		Fichaje fichaje = fetchByUserId_Last(userId, orderByComparator);
	...
	public Fichaje fetchByUserId_Last(long userId,
		...
		List<Fichaje> list = findByUserId(userId, count - 1, count,
				orderByComparator);
	...
	public Fichaje[] findByUserId_PrevAndNext(long fichajeId, long userId,
		...
		try {
			...
			array[0] = getByUserId_PrevAndNext(session, fichaje, userId,
					orderByComparator, true);

			array[1] = fichaje;

			array[2] = getByUserId_PrevAndNext(session, fichaje, userId,
					orderByComparator, false);
	...
	protected Fichaje getByUserId_PrevAndNext(Session session, Fichaje fichaje,
	...
	public void removeByUserId(long userId) {
		for (Fichaje fichaje : findByUserId(userId, QueryUtil.ALL_POS,
				QueryUtil.ALL_POS, null)) {
			remove(fichaje);
		}
	}
	...
	private static final String _FINDER_COLUMN_USERID_USERID_2 = "fichaje.userId = ?";
	...
	public Fichaje updateImpl(Fichaje fichaje) {
		...
		if (!FichajeModelImpl.COLUMN_BITMASK_ENABLED) {
		 ...
		 if (isNew) {
			...
			args = new Object[] { fichajeModelImpl.getUserId() };
			...
			if ((fichajeModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						fichajeModelImpl.getOriginalUserId()
					};
